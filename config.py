...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Pkgyar")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "BhoomiMusicBot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "BHOOMI MUSIC")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "NYKAA_ASS")
EVALOP = list(map(int, getenv("EVALOP", "6732649564").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/nothing022/Roymuc",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Pkgyar")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Pkgyar")
